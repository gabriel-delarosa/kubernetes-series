...
kubectl create namespace helm-tiller
kubectl create serviceaccount helm-tiller --namespace helm-tiller
...
echo "set key values"
export SUBJECT="/C=US/ST=/L=/O=aditazz/OU=DEVOPS/CN=aditazz.com"
